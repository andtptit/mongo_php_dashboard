...
<h2>
	Setup SKAD Info
	<a class="btn btn-primary float-right" href="<?php echo URL; ?>/user/create">
	...
	<tbody>
		<?php $no=0; foreach ($rows as $row) { $no++; ?>
			<tr>
				...
				<td>
					<div class="d-flex">
						<a href="<?php echo URL; ?>/user/edit/<?php echo $row['_id']; ?>" class="btn btn-sm btn-warning">
							<i class="fa fa-edit"></i> EDIT
						</a>
						<a href="<?php echo URL; ?>/user/show/<?php echo $row['_id']; ?>" class="btn btn-sm btn-info ml-2">
							<i class="fa fa-info-circle"></i> DETAIL
						</a>
						<form method="POST" action="<?php echo URL; ?>/user_proses.php" id="deleteForm">
